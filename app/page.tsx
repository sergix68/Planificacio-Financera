...
function DataPanel({ inputs, scenario, onSave, onImport }: { inputs: Inputs; scenario: Scenario; onSave: () => void; onImport: (file: File) => void }) {
